...
class DocumentSettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'logo' => 'nullable|image|mimes:png,jpg,jpeg|max:2048|dimensions:max_width=4000,max_height=2000',
            'secondary_logos' => 'nullable|array|max:3',
            'secondary_logos.*' => 'image|mimes:png,jpg,jpeg|max:2048|dimensions:max_width=4000,max_height=2000',
            'header_banner' => 'nullable|image|mimes:png,jpg,jpeg|max:4096|dimensions:max_width=6000,max_height=2000',
