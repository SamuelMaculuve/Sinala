...
<main class="mx-auto max-w-7xl p-4 sm:p-6 lg:p-10">
    ...
    @if($event->isClosed())
        <div class="mt-6 rounded-[32px] border border-stone-800 bg-stone-900/85 p-8">
            <h2 class="text-2xl font-bold">Evento encerrado</h2>
            <p class="mt-2 text-stone-400">Este evento foi fechado e já não é possível registar novas presenças.</p>
        </div>
    @else
